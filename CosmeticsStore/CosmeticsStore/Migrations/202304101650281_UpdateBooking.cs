namespace CosmeticsStore.Migrations
{
    ...
    public partial class UpdateBooking : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.tb_OrderDetails", "Service_Id", c => c.Int());
            CreateIndex("dbo.tb_OrderDetails", "Service_Id");
            AddForeignKey("dbo.tb_OrderDetails", "Service_Id", "dbo.tb_Service", "Id");
        }
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_OrderDetails", "Service_Id", "dbo.tb_Service");
            ...
            DropIndex("dbo.tb_OrderDetails", new[] { "Service_Id" });
            ...
            DropColumn("dbo.tb_OrderDetails", "Service_Id");
            DropTable("dbo.tb_ServiceImage");
            DropTable("dbo.tb_Service");
            DropTable("dbo.tb_Branchs");
